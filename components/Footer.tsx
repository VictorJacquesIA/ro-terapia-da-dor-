...
export default function Footer() {
  ...
  return (
    <footer style={{ background: "#1A1613" }} aria-label="Rodapé">
      <div className="container-content pt-16 pb-8">
        ...
        <div className="flex flex-col items-center text-center mb-10">
          <Image
            ...
            width={300}
            height={110}
            className="h-24 w-auto object-contain mb-4 brightness-0 invert opacity-90"
          />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 mb-10">
          ...
          <a
            ...
            className="flex items-center gap-2.5 text-white/45 hover:text-gold text-sm transition-colors duration-200"
        ...
        <div className="border-t border-white/6 pt-7 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a
            href="https://www.v2digital.com.br/"
            target="_blank"
            rel="noopener noreferrer"
