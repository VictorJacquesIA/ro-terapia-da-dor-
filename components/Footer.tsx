...
export default function Footer() {
  ...
  return (
    <footer style={{ background: "#1F1A17" }} aria-label="Rodapé">
      <div className="container-content py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          {/* Contact */}
          <div>
            <h3 className="text-white/80 font-semibold text-xs uppercase tracking-[0.14em] mb-5">
              Contato
            </h3>
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 text-white/60 hover:text-gold text-sm transition-colors duration-200"
              ...
              <li>
                <div className="flex items-start gap-2.5 text-white/60 text-sm">
                  <MapPin className="w-4 h-4 shrink-0 mt-0.5 text-gold/60" aria-hidden="true" />
                  <address className="not-italic leading-relaxed">
                    {siteConfig.address}<br />
                    <span className="text-white/35 text-xs">{siteConfig.cep}</span>
                  </address>
                </div>
              </li>
            </ul>
              ...
              {socialLinks.map((link) => (
                <li key={link.handle}>
                  ...
                  >
                    ...
                    <span>
                      <span className="block text-white/35 text-[10px] mb-0.5">{link.label}</span>
                      {link.handle}
                    </span>
                  </a>
                </li>
        ...
        <div className="border-t border-white/8 pt-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2" aria-hidden="true">
            ...
            <span className="text-white/20 text-xs">São José, SC</span>
          </div>
        </div>
      </div>
    </footer>
